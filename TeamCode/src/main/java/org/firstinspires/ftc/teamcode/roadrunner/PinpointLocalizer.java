...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -986.6766276685483; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -570.7033990668174; // x position of the perpendicular encoder (in tick units)
    }
